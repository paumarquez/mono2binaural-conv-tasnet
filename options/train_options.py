...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--validation_batches', type=int, default=50000, help='number of batches to test for validation')
		...
		self.parser.add_argument('--diff_loss_weight', type=float, default=0.0, help='Weight for the difference loss')
		self.parser.add_argument('--spectro_loss_weight', type=float, default=0.0, help='Weight for the difference loss')
		...
		self.parser.add_argument('--gradient_clip', default=5, type=float, help='gradient clip for tasnet')
