...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--split_file', required=True, help='path to the split file')
		...
		self.parser.add_argument('--split_subset', type=str, default='test', help="Subset to split validation, test and train")
